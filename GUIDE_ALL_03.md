...
1. Read and fully understand this document.
   This spec is the **only source of truth** for VibeLive interaction behavior, UI/UX, layout, and implementation rules.

2. Do not write code until explicitly instructed.

3. If any requirement is unclear, missing, or conflicting:
   Stop and ask before proceeding.
   Do not infer behavior or fill gaps.

4. Act as a senior engineer with strong design judgment.
   Prioritize correctness, clarity, and design integrity.

5. Before coding, **ask the user two design questions**:

   **a) Color theme** -- present the four options: **Teal**, **Nature Calm**, **Purple**, **Red**
   - The user may also specify a custom color
   - If the user skips or has no preference, **default to Teal** (`#0EA5A4`)

   **b) Display mode** -- ask: **Light mode** or **Dark mode**?
   - If the user skips or has no preference, **default to Light mode**
   - Apply the chosen mode's CSS variables (see Appendix B for both light and dark tokens per theme)

6. Before coding, confirm:
   - This spec was fully read
   - All interaction requirements were identified
   - The Copy Button Requirement is acknowledged and mapped to an implementation
   - A color theme has been selected (or defaulted to Teal)
   - A display mode has been selected (or defaulted to Light)

Failure to comply requires stopping before coding.
...
# Appendix B: VibeLive Color Systems & Design Tokens

VibeLive provides four official color themes. Each theme shares the same layout constants, component rules, and iconography standards. Choose the theme that best matches your application's personality.

> **LLM Implementation Note:** Before writing any code, ask the user:
> 1. **Which color theme?** Present the four options (Teal / Nature Calm / Purple / Red) and allow custom colors. Default: **Teal**.
> 2. **Light mode or Dark mode?** Default: **Light mode**.
>
> Each theme below includes both light and dark mode CSS variables.
...
| Theme | Brand Color | Best For |
|-------|-------------|----------|
| **Teal** | `#0EA5A4` | Modern, minimal, general-purpose |
| **Nature Calm** | `#556B2F` (Olive) | Grounded, low-saturation, long-session friendly |
| **Purple** | `#6E6282` | Creator tools, coaching, reflective conversations |
| **Red** | `#BF3143` | Bold, energetic, action-driven experiences |

---

## B.2 Shared Principles (All Themes)

1. **Neutral first, accent second:** most UI is neutral; accent color is for actions + meaning.
2. **One primary action per screen:** only one primary button in a view when possible.
...
## B.3 Theme: Teal (Default)

**Brand color:** `#0EA5A4` (VibeLive Teal)
...
| Token | Value | Usage |
|-------|-------|-------|
| `--liveBg` | `#e8f4ed` | Live/online background |
| `--liveBorder` | `#a6c5a3` | Live/online border |
| `--liveText` | `#324252` | Live/online text |
| `--disabledBg` | `#f3f4f6` | Disabled background |
| `--disabledBorder` | `#e5e7eb` | Disabled border |
...
| Token | Value | Usage |
|-------|-------|-------|
| `--bg` | `#0f1517` | Dark background |
| `--card` | `#1a2428` | Cards, panels, modals |
| `--soft` | `#1e2e32` | Hover surface, subtle fill |
| `--border` | `#2a3a3e` | Dividers, outlines |
| `--borderSoft` | `#354548` | Hover/emphasis borders |
...
| `--muted2` | `#64748b` | Tertiary / helper text |

#### Brand Accent
| Token | Value | Usage |
|-------|-------|-------|
| `--accent` | `#14b8b6` | Primary buttons, key links (brighter for dark bg) |
| `--accentHover` | `#0ea5a4` | Hover state |
| `--accentSoft` | `rgba(20,184,182,.15)` | Selected background tint |
| `--accentBorder` | `rgba(20,184,182,.35)` | Focus/outline |

#### Status
| Token | Value | Usage |
|-------|-------|-------|
| `--liveBg` | `#162a1e` | Live/online background |
| `--liveBorder` | `#2d5a3a` | Live/online border |
| `--liveText` | `#a6d4b8` | Live/online text |
| `--disabledBg` | `#1a1e22` | Disabled background |
| `--disabledBorder` | `#2a2e32` | Disabled border |
| `--disabledText` | `#4a5568` | Disabled text |
...
:root {
  ...
  --accent: #14b8b6;
  --accentHover: #0ea5a4;
  --accentSoft: rgba(20,184,182,.15);
  --accentBorder: rgba(20,184,182,.35);
...
## B.4 Theme: Nature Calm

**Brand color:** `#556B2F` (Olive Action)
**Identity color:** `#8DA399` (Dusty Sage)
...
| `--soft` | `#E6ECDC` | Olive Soft -- subtle highlights |
...
| Token | Value | Usage |
|-------|-------|-------|
| `--brand` | `#8DA399` | Dusty Sage -- icons/headers (identity, not CTA) |
...
| Token | Value | Usage |
|-------|-------|-------|
| `--liveBg` | `#E3E9E1` | Live/online background |
| `--liveBorder` | `#CBD5C8` | Live/online border |
| `--liveText` | `#3A443F` | Live/online text |
| `--disabledBg` | `#ECEFED` | Disabled background |
| `--disabledBorder` | `#E4E7E3` | Disabled border |
| `--disabledText` | `#9AA5A0` | Disabled text |
| `--dangerBg` | `#F2E8E6` | Error background |
| `--dangerBorder` | `#E3C7C2` | Error border |
| `--dangerText` | `#8B4A3E` | Error text |
...
| Token | Value | Usage |
|-------|-------|-------|
| `--bg` | `#111412` | Deep earth -- dark background |
| `--card` | `#1a1f1b` | Bark -- cards/modals |
| `--soft` | `#222a22` | Forest floor -- subtle highlights |
| `--border` | `#2e382e` | Shadow moss -- dividers |
| `--borderSoft` | `#3a4538` | Hover/emphasis border |

#### Text
| Token | Value | Usage |
|-------|-------|-------|
| `--text` | `#dde4db` | Pale sage -- primary text |
| `--muted` | `#9aa59e` | Faded fern -- secondary text |
| `--muted2` | `#6a756e` | Dried moss -- helper text |

#### Brand Accent
| Token | Value | Usage |
|-------|-------|-------|
| `--brand` | `#a3bfb2` | Moonlit sage -- identity (brighter for dark bg) |
| `--brandSoft` | `rgba(163,191,178,.15)` | Soft brand tint |
| `--accent` | `#6e8a3a` | Bright olive -- primary buttons/links |
| `--accentHover` | `#556B2F` | Hover/pressed |
| `--accentSoft` | `rgba(110,138,58,.15)` | Selected background tint |
| `--accentBorder` | `rgba(110,138,58,.35)` | Focus/outline |

#### Status
| Token | Value | Usage |
|-------|-------|-------|
| `--liveBg` | `#182218` | Live/online background |
| `--liveBorder` | `#2e4a2e` | Live/online border |
| `--liveText` | `#a8c8a6` | Live/online text |
| `--disabledBg` | `#181c1a` | Disabled background |
| `--disabledBorder` | `#282e2a` | Disabled border |
| `--disabledText` | `#525c56` | Disabled text |
| `--dangerBg` | `#2a1a18` | Error background |
| `--dangerBorder` | `#5a3530` | Error border |
| `--dangerText` | `#d4908a` | Error text |
...
:root {
  ...
  --brand: #a3bfb2;
  --brandSoft: rgba(163,191,178,.15);

  --accent: #6e8a3a;
  --accentHover: #556B2F;
  --accentSoft: rgba(110,138,58,.15);
  --accentBorder: rgba(110,138,58,.35);
...
| Token | Value | Usage |
|-------|-------|-------|
| `--bg` | `#121318` | Deep indigo -- dark background |
| `--card` | `#1c1d26` | Twilight -- cards/modals |
| `--soft` | `#242530` | Dusk -- hover surfaces |
| `--border` | `#323340` | Amethyst shadow -- borders |
| `--borderSoft` | `#3e3f50` | Hover/emphasis borders |

#### Text
| Token | Value | Usage |
|-------|-------|-------|
| `--text` | `#e0e2ec` | Lavender mist -- primary text |
| `--muted` | `#9a9cb8` | Faded violet -- secondary text |
| `--muted2` | `#6a6c82` | Dim plum -- helper text |

#### Brand Accent
| Token | Value | Usage |
|-------|-------|-------|
| `--accent` | `#8a7ca0` | Bright amethyst -- primary buttons (brighter for dark bg) |
| `--accentHover` | `#6E6282` | Hover/active state |
| `--accentSoft` | `rgba(138,124,160,.15)` | Selected/highlight background |
| `--accentBorder` | `rgba(138,124,160,.35)` | Focus ring/outline |
...
| `--liveBorder` | `#2d5a3a` | Live/online border |
| `--liveText` | `#a6d4b8` | Live/online text |
| `--disabledBg` | `#1a1b22` | Disabled background |
| `--disabledBorder` | `#2a2b34` | Disabled border |
| `--disabledText` | `#4a4c58` | Disabled text |
...
:root {
  ...
  --accent: #8a7ca0;
  --accentHover: #6E6282;
  --accentSoft: rgba(138,124,160,.15);
  --accentBorder: rgba(138,124,160,.35);
...
**Brand color:** `#BF3143`
**Style:** bold, energetic, action-driven
...
| Token | Value | Usage |
|-------|-------|-------|
| `--liveBg` / `--successBg` | `#E8F4ED` | Live/online/success background |
| `--liveBorder` / `--successBorder` | `#A6C5A3` | Live/online/success border |
| `--liveText` / `--successText` | `#324252` | Live/online/success text |
| `--disabledBg` | `#F3F4F6` | Disabled background |
| `--disabledBorder` | `#E5E7EB` | Disabled border |
| `--disabledText` | `#6B7280` | Disabled text |
...
| Token | Value | Usage |
|-------|-------|-------|
| `--bg` | `#131214` | Charcoal -- dark background |
| `--card` | `#1e1b20` | Smoke -- cards/modals |
| `--soft` | `#28232a` | Ember shadow -- hover surfaces |
| `--border` | `#382e3a` | Dark plum -- borders |
| `--borderSoft` | `#443a46` | Hover/emphasis borders |

#### Text
| Token | Value | Usage |
|-------|-------|-------|
| `--text` | `#e8e2ea` | Pale rose -- primary text |
| `--muted` | `#a098a8` | Dusty mauve -- secondary text |
| `--muted2` | `#6e6678` | Faded plum -- helper text |

#### Brand Accent
| Token | Value | Usage |
|-------|-------|-------|
| `--accent` | `#d94458` | Bright crimson -- primary buttons (brighter for dark bg) |
| `--accentSoft` | `rgba(217,68,88,.12)` | Selected backgrounds |
| `--accentHover` | `rgba(217,68,88,.20)` | Hover feedback |
| `--accentBorder` | `rgba(217,68,88,.30)` | Accent borders |

#### Status
| Token | Value | Usage |
|-------|-------|-------|
| `--liveBg` / `--successBg` | `#162a1e` | Live/online/success background |
| `--liveBorder` / `--successBorder` | `#2d5a3a` | Live/online/success border |
| `--liveText` / `--successText` | `#a6d4b8` | Live/online/success text |
| `--disabledBg` | `#1a181c` | Disabled background |
| `--disabledBorder` | `#2a262c` | Disabled border |
| `--disabledText` | `#4e4854` | Disabled text |
...
:root {
  ...
  --accent: #d94458;
  --accentSoft: rgba(217,68,88,.12);
  --accentHover: rgba(217,68,88,.20);
  --accentBorder: rgba(217,68,88,.30);

  --successBg: #162a1e;
  --successBorder: #2d5a3a;
  --successText: #a6d4b8;

  --disabledBg: #1a181c;
  --disabledBorder: #2a262c;
  --disabledText: #4e4854;
...
## B.7 Component Rules (All Themes)
...
**Danger (Rare)**
- Background: `#FEF2F2` (or `--dangerBg` for Nature theme)
- Border: `#fca5a5` (or `--dangerBorder` for Nature theme)
- Text: `#b91c1c` (or `--dangerText` for Nature theme)
...
## B.8 Modals, Toasts, Alerts (All Themes)
...
## B.10 Do / Don't Guidelines (All Themes)

**Do**
- Use the accent color primarily for key actions and emphasis
- Keep backgrounds neutral and clean
- Use Live/success green only for real "live/online/enabled" states

**Don't**
- Add random new colors for every feature
- Use multiple accent CTAs on the same screen
